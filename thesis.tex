...
\begin{document}
    ...
    \section{実験と考察} % セクション．実験
        ...
        \subsection{予備実験} \label{threshold}
            ...
            図\ref{DSC0087}，図\ref{DSC0100}におけるしきい値をヨコ軸に，タテ軸に白石の感度と特異度の割合をプロットしたグラフをそれぞれ図\ref{Case1White}と図\ref{Case2White}に，
        ...
        \label{identify_result}
            ...
            \subsubsection{事例1}
                石の位置にずれがなく，反射光の映り込みが少ない状況に対し，システムを適用する．
